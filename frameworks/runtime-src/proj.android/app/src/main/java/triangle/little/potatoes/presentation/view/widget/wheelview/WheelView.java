...
package triangle.little.potatoes.presentation.view.widget.wheelview;
...
public class WheelView extends View {
			...
			if (animated) {
				...
				if (mLastView != null) {
					if (mLastView instanceof TextView) {
						...
						mLastView = mLastView.findViewById(R.id.wheel_view_item_tv);
						if (mLastView != null) {
							((TextView) mLastView).setTextColor(Color.parseColor("#b4b4b4"));
						}
					}
				...
				if (mCurrentView != null) {
					if (mCurrentView instanceof TextView) {
						...
						mCurrentView = mCurrentView.findViewById(R.id.wheel_view_item_tv);
						if (mCurrentView != null) {
							((TextView) mCurrentView).setTextColor(Color.parseColor("#1c1c1c"));
						}
					}
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.color_CC75FF));
		// 设置线宽
