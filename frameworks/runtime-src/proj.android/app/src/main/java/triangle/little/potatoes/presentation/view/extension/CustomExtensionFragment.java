...
import triangle.little.potatoes.presentation.rxbus.RxBus;
import triangle.little.potatoes.presentation.rxbus.event.ExtensionHeaderEvent;
...
import triangle.little.potatoes.presentation.view.product.search.ExtensionExtraItem;
import triangle.little.potatoes.presentation.view.product.search.ProductSearchActivity;
import triangle.little.potatoes.presentation.view.product.search.SearchType;

import java.util.List;

import butterknife.BindView;

import static triangle.little.potatoes.presentation.view.extension.CustomExtensionHeaderFragment.ADD_HEADER_GAME_REQUEST_CODE;
