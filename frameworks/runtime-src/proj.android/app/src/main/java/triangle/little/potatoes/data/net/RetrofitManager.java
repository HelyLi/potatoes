package triangle.little.potatoes.data.net;

import android.util.SparseArray;

import triangle.little.potatoes.application.App;
import triangle.little.potatoes.data.config.SystemConfig;
import triangle.little.potatoes.data.net.cookie.PersistentCookieJar;
import triangle.little.potatoes.data.net.cookie.SetCookieCache;
import triangle.little.potatoes.data.net.cookie.SharedPrefsCookiePersistor;
import triangle.little.potatoes.presentation.utils.JsonUtil;
