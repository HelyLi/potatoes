...
import triangle.little.potatoes.data.net.protocol.user.GetRealNameReq;
import triangle.little.potatoes.data.net.protocol.user.GetRealNameResp;
import triangle.little.potatoes.data.net.protocol.user.SmsCodeReq;
import triangle.little.potatoes.data.net.protocol.user.SmsCodeResp;
import triangle.little.potatoes.data.net.protocol.user.UpdateBankInfoReq;
import triangle.little.potatoes.data.net.protocol.user.UpdateBankInfoResp;
