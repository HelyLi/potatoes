package triangle.little.potatoes.presentation.view.widget;
...
public class HorizontalProgressBarWithNumber extends ProgressBar {
     ...
     * size of text (sp)
     */
    protected int mTextSize = DisplayUtil.dip2px(getContext(), DEFAULT_TEXT_SIZE);

    /**
     * offset of draw progress
     */
    protected int mTextOffset = DisplayUtil.dip2px(getContext(), DEFAULT_SIZE_TEXT_OFFSET);

    /**
     * height of reached progress bar
     */
    protected int mReachedProgressBarHeight = DisplayUtil.dip2px(getContext(), DEFAULT_HEIGHT_REACHED_PROGRESS_BAR);
     ...
     */
    protected int mUnReachedProgressBarHeight = DisplayUtil.dip2px(getContext(), DEFAULT_HEIGHT_UNREACHED_PROGRESS_BAR);
    /**
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        mTextColor = attributes.getColor(
                R.styleable.HorizontalProgressBarWithNumber_progress_text_color, DEFAULT_TEXT_COLOR);
